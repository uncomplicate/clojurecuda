...
#define __CPP_VERSION_AT_LEAST_11_FP8
        ...
        #define __CUDA_FP8_INTERNAL_CAN_RELY_ON_PTX_FOR_SHORTTYPESCVT__ (1)
    #else
        // instructions unsupported, fallback to emulation
        #define __CUDA_FP8_INTERNAL_CAN_RELY_ON_PTX_FOR_SHORTTYPESCVT__ (0)
    #endif
#else /* ( (defined __CUDA_ARCH__) && (__CUDA_ARCH__ >= 1000) && (defined __CUDA_ARCH_FAMILY_SPECIFIC__) ) */
    // instructions unsupported, fallback to emulation
    #define __CUDA_FP8_INTERNAL_CAN_RELY_ON_PTX_FOR_SHORTTYPESCVT__ (0)
#endif /* ( (defined __CUDA_ARCH__) && (__CUDA_ARCH__ >= 1000) && (defined __CUDA_ARCH_FAMILY_SPECIFIC__) ) */
