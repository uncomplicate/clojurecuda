...
#include "cuda_device_runtime_api.h"
    ...
    #define cudaStreamGetDevResource       __CUDART_API_PTSZ(cudaStreamGetDevResource)
 ...
 * ::cudaGraphExecGetId
 */
extern __host__ cudaError_t CUDARTAPI cudaGraphNodeGetContainingGraph(cudaGraphNode_t hNode, cudaGraph_t *phGraph);
 ...
 * ::cudaGraphExecGetId
 */
extern __host__ cudaError_t CUDARTAPI cudaGraphNodeGetLocalId(cudaGraphNode_t hNode, unsigned int *nodeId);
 ...
 */
extern __host__ cudaError_t CUDARTAPI cudaGraphNodeGetToolsId(cudaGraphNode_t hNode, unsigned long long *toolsNodeId);
 ...
 * ::cudaGraphExecGetId
 */
extern __host__ cudaError_t CUDARTAPI cudaGraphGetId(cudaGraph_t hGraph, unsigned int *graphID);
 ...
 * ::cudaGraphGetId
 */
extern __host__ cudaError_t CUDARTAPI cudaGraphExecGetId(cudaGraphExec_t hGraphExec, unsigned int *graphID);
 ...
 * ::cuGraphAddNode,
 */
extern __host__ cudaError_t CUDARTAPI cudaGraphConditionalHandleCreate_v2(cudaGraphConditionalHandle *pHandle_out, cudaGraph_t graph, cudaExecutionContext_t ctx __dv(NULL), unsigned int defaultLaunchValue __dv(0), unsigned int flags __dv(0));
 ...
 */
extern __host__ cudaError_t CUDARTAPI cudaDeviceGetDevResource(int device, cudaDevResource *resource, enum cudaDevResourceType type);
 ...
 * ::cudaDevResourceGenerateDesc
 */
extern __host__ cudaError_t CUDARTAPI cudaDevSmResourceSplitByCount(
    cudaDevResource *result, unsigned int *nbGroups, const cudaDevResource *input, cudaDevResource *remaining, unsigned int flags, unsigned int minCount);
 ...
 * ::cudaDevResourceGenerateDesc
 */
extern __host__ cudaError_t CUDARTAPI cudaDevSmResourceSplit(
 ...
 * ::cudaGreenCtxCreate
 */
extern __host__ cudaError_t CUDARTAPI cudaDevResourceGenerateDesc(cudaDevResourceDesc_t *phDesc, cudaDevResource *resources, unsigned int nbResources);
 ...
 */
extern __host__ cudaError_t CUDARTAPI cudaGreenCtxCreate(cudaExecutionContext_t *phCtx, cudaDevResourceDesc_t desc, int device, unsigned int flags);
 ...
 * ::cudaGreenCtxCreate
 */
extern __host__ cudaError_t CUDARTAPI cudaExecutionCtxDestroy(cudaExecutionContext_t ctx);
 ...
 * ::cudaGreenCtxCreate
 */
extern __host__ cudaError_t CUDARTAPI cudaExecutionCtxGetDevResource(cudaExecutionContext_t ctx, cudaDevResource *resource, enum cudaDevResourceType type);
 ...
 * ::cuCtxGetDevice
 */
extern __host__ cudaError_t CUDARTAPI cudaExecutionCtxGetDevice(int *device, cudaExecutionContext_t ctx);
 ...
 * ::cuCtxGetId
 */
extern __host__ cudaError_t CUDARTAPI cudaExecutionCtxGetId(cudaExecutionContext_t ctx, unsigned long long *ctxId);
 ...
 * ::cudaStreamAddCallback
 */
extern __host__ cudaError_t CUDARTAPI cudaExecutionCtxStreamCreate(cudaStream_t *phStream, cudaExecutionContext_t ctx, unsigned int flags, int priority);
 ...
 * ::cuCtxSynchronize_v2
 */
extern __host__ cudaError_t CUDARTAPI cudaExecutionCtxSynchronize(cudaExecutionContext_t ctx);
 ...
 */
extern __host__ cudaError_t CUDARTAPI cudaStreamGetDevResource(cudaStream_t hStream, cudaDevResource *resource, enum cudaDevResourceType type);
 ...
 */
extern __host__ cudaError_t CUDARTAPI cudaExecutionCtxRecordEvent(cudaExecutionContext_t ctx, cudaEvent_t event);
 ...
 * ::cuGreenCtxWaitEvent
 */
extern __host__ cudaError_t CUDARTAPI cudaExecutionCtxWaitEvent(cudaExecutionContext_t ctx, cudaEvent_t event);
 ...
 */
extern __host__ cudaError_t CUDARTAPI cudaDeviceGetExecutionCtx(cudaExecutionContext_t *ctx, int device);
...
/** @} */ /* END CUDART_DRIVER */
    ...
    #undef cudaStreamGetDevResource
